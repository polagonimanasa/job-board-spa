...
// --- 5. Intent-Driven Search & Auto-Reset ---
...
DOM.searchInput.addEventListener('keydown', (e) => {
    ...
    if (e.key === 'Enter') {
        ...
        if (query) {
            ...
            // ---> NEW ADDITION: Instant Stage Clear <---
            // Completely empty the visual text field immediately after execution
            e.target.value = '';
        }
    }
});

// 2. Smart Auto-Reset Listener (Retained)
